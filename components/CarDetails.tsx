                    ...
                    <div className="flex min-h-full items-center justify-center p-4 text-center"> 
                        <Transition.Child as={Fragment}
                            ...
                            <Dialog.Panel className="relative w-full max-w-lg max-h-[90vh] p-6
                                ...
                                <button type="button" onClick={closeModal} className="fixed top-2 
                                right-2 z-10 self-end w-fit bg-primary-blue-100 rounded-full">
                                ...
                                <div className="flex-1 flex flex-col gap-3">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        rounded-lg ">
                                            <Image src={generateCarImageUrl(car, '29')} alt="car model" fill={true} priority
                                                className="object-contain"/>
                                        </div>
                                        <div className="flex-1 relative w-full h-24 bg-primary-blue-100
                                        rounded-lg ">
                                            <Image src={generateCarImageUrl(car, '33')} alt="car model" fill={true} priority
                                                className="object-contain"/>
                                        </div>
                                        <div className="flex-1 relative w-full h-24 bg-primary-blue-100
                                        rounded-lg ">
                                            <Image src={generateCarImageUrl(car, '13')} alt="car model" fill={true} priority
                                                className="object-contain"/>
                                        </div>
                                    </div>
                                </div>
